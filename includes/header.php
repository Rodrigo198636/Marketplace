...
if (isset($_SESSION['user_id'])) {
    $number = $conn->query("SELECT COUNT(*) as num_products FROM carrito WHERE user_id='$_SESSION[user_id]'");
    $number->execute();
        ...
        <div class="container" style="margin-top: none">
            ...
            <button class="btn btn-outline-success" type="submit">Search</button>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active  text-white" aria-current="page" href="<?php echo APPURL; ?>">Inicio</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link  text-white" href="<?php echo APPURL; ?>/shopping/contact.php">Contacto</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/orders.php?=id<?php echo $_SESSION['user_id']; ?>">Ordenes</a></li>
                                <!-- <li><a class="dropdown-item" href="#">Another action</a></li> -->
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/auth/logout.php">Salir</a></li>
                            </ul>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link  text-white" href="<?php echo APPURL; ?>/auth/login.php">Ingresar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  text-white" href="<?php echo APPURL; ?>/auth/register.php">Registrarse</a>
                        </li>
                    <?php endif; ?>
                </ul>
